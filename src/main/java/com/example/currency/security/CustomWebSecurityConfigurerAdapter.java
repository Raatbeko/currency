...
class CustomWebSecurityConfigurerAdapter extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .antMatchers(HttpMethod.GET,"api/v1/currency/currencies").hasRole("USER")
                .antMatchers(HttpMethod.GET,"api/v1/currency/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST,"api/v1/currency/").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT,"api/v1/currency/{id}").hasRole("ADMIN")
                .and()
                .httpBasic();
    }
